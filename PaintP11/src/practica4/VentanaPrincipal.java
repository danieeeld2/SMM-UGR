...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    /**
     * Método que, dado una forma, toma los atributos de dicha forma y los coloca
     * en la barra de herramientas, para que esta esté siempre actualizada y en sintonía
    ...
    /**
     * Clase manejadora para manejar eventos de las formas asociadas a un lienzo desde la ventana principañ
     */
    public class MiManejadorLienzo extends LienzoAdapter{
        /**
         * Método que imprime por terminal una forma cuando esta es añadida a uno de los lienzos
         * @param evt 
         */
        @Override
        ...
        /**
         * Método que establece los atributos de una forma seleccionada en la barra de herramientas
         * @param evt 
         */
        @Override
    ...
    /**
     * Evento Action del Boton Rectangulo. Entra en el modo de dibujado de rectangulos
     * @param evt 
     */
    ...
    /**
     * Evento Action del Boton Abrir. Permite abrir una imagen, a través de un diálodo, en formatos
     * jpg, jpeg, png, gif y bmp. En caso de éxito, crea una nueva ventana interna y crea una imagen con
     * canal alfa a partir de la original, la cual establece como fondo del lienzo asociado
     * @param evt 
     */
    ...
    /**
     * Evento Action del botón Guardar. Permite volcar todo el contenido del lienzo para guardarlo
     * sobre un archivo en nuestro sistema con extensiones: jpg, jpeg, png, gif y bmp (Por defecto
     * jpg)
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Fantasma. Entra en el modo de dibujado de fantasmas
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Mover. Entra en el modo edición, permitiendo seleccionar figuras,
     * moverlas y cambiarles sus atributos
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Trasparencia. Entra en el modo de dibujado con transparencia a 0.5
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Alisar. Entra en el modo de dibujado con alisado para formas circulares
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Grosor. Establece el grosor al que se van a dibujar las formas
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Paleta. Lanza un diálogo para elegir y establecer el color del que se pintarán las formas
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton Volcar. Permite volcar la forma seleccionada sobre la imagen, sacándola del vector de
     * formas seleccionables y quedando ya "impresa" en el fondo
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton auxiliar RescaleOp para probar dicha funcionalidad de forma rapida
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton auxiliar ConvolveOp para probar dicha funcionalidad de forma rapida
     * @param evt 
     */
    ...
    /**
     * Evento FocusGain del deslizador Brillo. Crea una copia de la imagen del lienzo seleccionado
     * @param evt 
     */
    ...
    /**
     * Evento FocusLost del deslizador Brillo. Elimina la copia de la imagen creada cuando gana el foco
     * @param evt 
     */
    ...
    /**
     * Evento StateChange del deslizador Brillo. Realiza un RescaleOp de parámetros a=1 y b=Brillo.getValue
     * sobre la copia realizada cuando obtiene el foco. Además la establece de fondo del lienzo para ver 
     * los cambios a tiempo real.
     * @param evt 
     */
    ...
    /**
     * Evento FocusGain del deslizador Contraste. Crea una copia de la imagen del lienzo seleccionado
     * @param evt 
     */
    ...
    /**
     * Evento FocusLost del deslizador Contraste. Elimina la copia de la imagen creada cuando gana el foco
     * @param evt 
     */
    ...
    /**
     * Evento StateChange del deslizador Contraste. Realiza un RescaleOp de parámetros a=Brillo.getValue y b=1
     * sobre la copia realizada cuando obtiene el foco. Además la establece de fondo del lienzo para ver 
     * los cambios a tiempo real.
     * @param evt 
     */
    ...
    /**
     * Evento Action de la lista desplegable de Filtros. Realiza una convolución sobre la imagen
     * del lienzo seleccionado, tomando como filtro el asociado al indice seleccionado.
     * @param evt 
     */
    ...
    /**
     * Evento FocusGain del deslizador Cometa. Crea una copia de la imagen del lienzo seleccionado
     * @param evt 
     */
    ...
    /**
     * Evento FocusLost del deslizador Cometa. Elimina la copia de la imagen creada cuando gana el foco
     * @param evt 
     */
    ...
    /**
     * Evento StateChange del deslizador Cometa. Aplica una convolución de emborrononamiento horizontal, con matriz
     * de tamaño nxn, donde n=valor del deslizador, n impar. La convolución se aplica sobre la copia de la imagen
     * creada cuando gana el foco y va estableciendo el resultado como fondo del lienzo para ver los cambios a
     * tiempo real.
     * @param evt 
     */
    ...
    /**
     * Evento Action del botón CombinarBandas. Utiliza el operador BandCombineOp para
     * establecer cada banda como la media de las otras dos. Hay que tener en cuenta que 
     * tengo canal alpha, por lo que tengo 4 bandas en vez de 3 como indica el guión
     * @param evt 
     */
     ...
     * genera nuevas ventanas internas, cada una con una imagen en escala de grises del raster
     * de cada banda que compone la imagen
     * @param evt 
     */
    ...
    /**
     * Evento Action del boton EspacioColor. Permite cambiar el espacio de color de la imagen asociada
     * a la ventana interna seleccionada
     * @param evt 
     */
    private void EspacioColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EspacioColorActionPerformed
        ...
        if(vi != null) {
            ...
            if(img != null) {
                ...
                ColorSpace cs = null;
                switch(index){
                    case 0 -> cs = ColorSpace.getInstance(ColorSpace.CS_sRGB);
                    case 1 -> cs = ColorSpace.getInstance(ColorSpace.CS_PYCC);
                    case 2 -> cs = ColorSpace.getInstance(ColorSpace.CS_GRAY);
                }
    ...
    /**
     * Método auxiliar que crea el filtro para el emborronamiento horizontal (cometa) de tamaño n*n
     * @param n tamaño a usar (se creará de n*n)
     * @return filtro de la convolución
     */
    ...
    /**
     * Método que dado una imagen y un índice de banda nos devuelve una imagen nueva en escala 
     * de grises con los valores de la banda indicada
    ...
    private BufferedImage getImageBand(BufferedImage img, int banda) {
        ...
        if(banda == 0 && img.getColorModel().hasAlpha()){
            bRaster = (WritableRaster) img.getAlphaRaster().createCompatibleWritableRaster(0, 0, img.getWidth(), img.getHeight());
        } else {
            //Creamos el nuevo raster a partir del raster de la imagen original
            bRaster = (WritableRaster) img.getRaster().createWritableChild(0, 0,
